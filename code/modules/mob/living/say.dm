GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	":a" = SQUAD_MARINE_1, ".a" = RADIO_CHANNEL_UNION, "#a" = RADIO_CHANNEL_CLF_MED,
	":b" = SQUAD_MARINE_2, ".b" = RADIO_CHANNEL_MILG, "#b" = RADIO_CHANNEL_CLF_ENGI,
	":c" = SQUAD_MARINE_3, ".c" = RADIO_CHANNEL_MILP, "#c" = RADIO_CHANNEL_CLF_CMD,
	":d" = SQUAD_MARINE_4, ".d" = RADIO_CHANNEL_SP, "#d" = RADIO_CHANNEL_CLF_CCT,
	":e" = SQUAD_MARINE_5, ".e" = RADIO_CHANNEL_MD, "#e" = RADIO_CHANNEL_PMC_ENGI,
	":f" = SQUAD_MARINE_CRYO, ".f" = RADIO_CHANNEL_IND, "#f" = RADIO_CHANNEL_PMC_MED,
