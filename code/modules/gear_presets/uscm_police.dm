...
/datum/equipment_preset/uscm_ship/uscm_police/mp/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/device/radio/headset/almayer/mp(new_human), WEAR_L_EAR)
...
/datum/equipment_preset/uscm_ship/uscm_police/warden/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/device/radio/headset/almayer/cmp(new_human), WEAR_L_EAR)
